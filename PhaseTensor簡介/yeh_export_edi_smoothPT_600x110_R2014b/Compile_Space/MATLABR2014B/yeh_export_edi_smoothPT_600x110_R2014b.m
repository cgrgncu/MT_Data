...
%   Author: HsiupoYeh 
%   Version: v20221006a
%   Description: 輸出HsiupoYeh建議的大地電磁法視電阻率及相位圖(WxH=600x110)
...
%--------------------------------------------------------------------------
    % colorbar， REF:https://www.mathworks.com/matlabcentral/fileexchange/69470-custom-colormap
...
% 輸出目標區域到檔案
    ...
    %--
    disp(['開始輸出圖檔(WxH=',num2str(length(pt_image_data(1,:,1))),'x',num2str(length(pt_image_data(:,1,1))),')...'])
