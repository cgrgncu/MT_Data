%**************************************************************************
%   Name: yeh_export_edi_rhophs_A_300x480.m 
%   Copyright:  
%   Author: HsiupoYeh 
%   Version: v20221009a
...
%               「R2014b」。
%**************************************************************************
function ExportEdiPNG=yeh_export_edi_rhophs_B_300x480(varargin)
    %======================================================================
    %----------------------------------------------------------------------
    % 輸出預設值
    ...
    if nargin==4 
        ...
        disp('output_png_file_name=[''yeh_export_edi_rhophs_B_300x480_v20221009a.png''];')
