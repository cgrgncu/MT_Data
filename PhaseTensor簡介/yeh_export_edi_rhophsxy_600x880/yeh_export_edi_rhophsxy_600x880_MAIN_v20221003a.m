%**************************************************************************
%   Name: yeh_export_edi_rhophsxy_600x880_MAIN_v20221003a.m 
%   Copyright:  
%   Author: HsiupoYeh 
%   Version: v20221003a
...
output_png_file_name='yeh_export_edi_rhophsxy_600x880_v20221003a.png';
ExportEdiPNG=yeh_export_edi_rhophsxy_600x880(Input_WinGLinkEdi_mat,Input_title,output_png_path,output_png_file_name);
...
%     return
% end
% output_png_file_name=['yeh_export_edi_rhophsxy_600x880_v20221003a_',MATLAB_Version_str,'.png'];
% ExportEdiPNG=yeh_export_edi_rhophsxy_600x880(Input_WinGLinkEdi_mat,Input_title,output_png_path,output_png_file_name);
% imshow(ExportEdiPNG.FileFullName)
%--------------------------------------------------------------------------