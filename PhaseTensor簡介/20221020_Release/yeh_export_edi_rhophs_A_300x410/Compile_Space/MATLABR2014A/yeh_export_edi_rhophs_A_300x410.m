%**************************************************************************
%   Name: yeh_export_edi_rhophs_A_300x410.m 
%   Copyright:  
%   Author: HsiupoYeh 
%   Version: v20221020a
...
%**************************************************************************
function ExportEdiPNG=yeh_export_edi_rhophs_A_300x410(varargin)
    %----------------------------------------------------------------------
    ...
    if nargin==4 
        ...
        disp('output_png_file_name=[''yeh_export_edi_rhophs_A_300x410_v20221020a.png''];')
        disp('ExportEdiPNG=yeh_export_edi_rhophs_A_300x410(Input_WinGLinkEdi_filename,Input_title,output_png_path,output_png_file_name);')
        disp('imshow([output_png_path,output_png_file_name])')  
        disp('--')
        disp('DOS Usage:')
        disp('yeh_export_edi_rhophs_A_300x410.exe "./xxx.edi" "DEMO001 Rot: 0.0 [°]" "./Output/" "yeh_export_edi_rhophs_A_300x410_v20221020a.png"')   
        disp('Hint:')
