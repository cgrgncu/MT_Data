%**************************************************************************
%   Name: yeh_export_edi_rhophsxy_300x480_MAIN_v20221002a.m 
%   Copyright:  
%   Author: HsiupoYeh 
%   Version: v20221002a
...
output_png_file_name='yeh_export_edi_rhophsxy_300x480_v20221001a.png';
...
%     return
% end
% output_png_file_name=['yeh_export_edi_rhophsxy_300x480_v20221001a_',MATLAB_Version_str,'.png'];
% ExportEdiPNG=yeh_export_edi_rhophsxy_300x480(Input_WinGLinkEdi_mat,Input_title,output_png_path,output_png_file_name);
% imshow(ExportEdiPNG.FileFullName)
%--------------------------------------------------------------------------