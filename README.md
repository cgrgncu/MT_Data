...
%   Author: HsiupoYeh 
%   Version: v20220928a
%   Description: 輸出HsiupoYeh建議的大地電磁法視電阻率圖(WxH=300x250)
%**************************************************************************
clear;clc;close all
%==========================================================================
%--------------------------------------------------------------------------
...
my_ylim_vector=[-2,5];
    ...
    horizontal_line=double(temp_frame.cdata(1000-axes_bottom_pexel_index+2,:,1));    
...
box_padding_right_px=28;
    % 輸出目標區域到檔案
    output_png_file_name=['yeh_export_edi_rho_v20220928a_',MATLAB_Version_str,'.png'];
